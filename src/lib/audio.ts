/**
 * Audio handling utility for Luci Live API Voice stream.
 * Handles:
  ...
  public async connect() {
    ...
    try {
      ...
      this.ws.onopen = async () => {
        console.log("[Luci] Connected to server side WS bridge");
        try {
...
export type MyraaAudioSession = LuciAudioSession;
